...
body = ''.join([
    ...
    para('באתר מחכים לכם תכנים וכלים על טנטרומים והתפרצויות, גבולות, הצטרפות של אח חדש, שינה והקשר שנבנה בין האחים. תוכלו למצוא בו גם את המדריכים הדיגיטליים, הליווי האישי וכל הדרכים להצטרף לקהילת ״אמאל׳ה צמודים״.'),
    para('הכול במקום אחד, כדי שתוכלו להתחיל ממה שמעסיק אתכם בבית עכשיו.'),
    ...
    para('לא צריך לתכנן חג מושלם שבו הילדים יישבו, יאכלו ויירדמו בדיוק בזמן. המטרה היא להגיע עם יותר בהירות: לדעת מה חשוב לכם לשמור, איפה אפשר להתגמש ומתי התוכנית כבר לא מתאימה לילדים.'),
